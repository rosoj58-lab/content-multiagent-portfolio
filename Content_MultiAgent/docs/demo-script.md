...
Open the draft and report side by side. The talking point is FR18: failed checks do
not become vague errors; they become revision guidance with a target stage.
...
Human review is a feature, not a failure: the workflow preserves control where
publication fit matters.
