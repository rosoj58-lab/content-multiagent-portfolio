...
def test_interview_cheatsheet_covers_pitch_tradeoffs_and_questions() -> None:
    ...
    assert "debug_snapshot.json" in cheatsheet
    assert "present/missing" in cheatsheet
...
def test_roadmap_documents_mvp_next_steps_and_deferred_scope() -> None:
    ...
    assert "debug_snapshot.json" in roadmap
...
def test_artifact_map_identifies_storage_and_qa_decisions() -> None:
    ...
    assert "debug_snapshot.json" in artifact_map
    ...
    assert "english_original_rejected.md" in artifact_map
